        ...
        fragments.append(
            {
                ...
                "score": _safe_float(m.get("selection_score", m.get("score", m.get("css")))),
                "selection_score": _safe_float(m.get("selection_score", m.get("score", m.get("css")))),
                "evidence_score": _safe_float(m.get("score", m.get("css"))),
                "truth_score": _safe_float(m.get("truth_score")),
                "truth_score_logit": _safe_float(m.get("truth_score_logit")),
                "truth_score_accepted": bool(m.get("truth_score_accepted", False)),
                "legacy_accepted": bool(m.get("legacy_accepted", True)),
                ...
                "num_missing_peaks": int(m.get("num_missing_peaks", 0) or 0),
                "pc_missing_peaks": _safe_float(m.get("pc_missing_peaks")),
                "fit_score": _safe_float(m.get("fit_score")),
                "correlation_coefficient": _safe_float(m.get("correlation_coefficient")),
                "chisq_stat": _safe_float(m.get("chisq_stat")),
                "mass_error_std": _safe_float(m.get("mass_error_std")),
